...
public class LogDemo {
	...
	public static void main(String[] args) {
		try {
			 ...
			 * LogManager.getContext(false); ConfigurationSource source = new
			 * ConfigurationSource(new
			 * FileInputStream("src/main/resources/config/log4j2.xml"));
			 * XmlConfiguration xmlConfig = new XmlConfiguration(context,
			 * source); LoggerContext.getContext().start(xmlConfig); Logger
			 * logger = (Logger)
			 ...
			 * System.out.println("Loading logging config file: " + fc); Logger
			 * logger = (Logger)
			 * LogManager.getLogger(LogManager.ROOT_LOGGER_NAME);
