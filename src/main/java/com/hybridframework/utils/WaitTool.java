...
public class WaitTool{
	...
	//Instantiation of driver should be changed, declared it here for time being to avoid compilation errors
 ...
 public static void impliciteWait(int timeToWaitInSec) {
